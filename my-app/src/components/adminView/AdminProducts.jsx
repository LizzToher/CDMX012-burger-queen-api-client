...
const AdminProducts = ({ products, setNavSection, handleLogOut }) => {
  ...
  if(addProduct === 'addProduct') {
    return (
      <>
        <AddProduct setAddProduct={setAddProduct} products={products} setNavSection={setNavSection} handleLogOut={handleLogOut}/>
      </>
    );
  }
  ...
  return (
    <div className={styles.container}>
      ...
      <div>
        <button className={styles.deleteProduct} onClick={() => setAddProduct('addProduct')}>Agregar</button>
      </div>
    </div>
  );
